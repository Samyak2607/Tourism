  ...
  <section id="container">
    ...
    <!--header start-->
     <header class="header black-bg">
      ...
      <!--logo start-->
      <a href="index.jsp" class="logo"><b>TRAVE<span>LO</span></b></a>
      <!--logo end-->
      ...
      <div class="top-menu">
        <ul class="nav pull-right top-menu">
          <li><a class="logout" href="../signin/signin.html">Logout</a></li>
        </ul>
      </div>
    </header>
    <!--header end-->
    ...
    <aside>
      <div id="sidebar" class="nav-collapse ">
        ...
        <ul class="sidebar-menu" id="nav-accordion">
          <p class="centered"><a href="profile.jsp"><img src="img/pic.png" class="img-circle" width="80"></a></p>
            ...
            <section class="panel">
              <div class="panel-body">
                ...
                <ul class="nav nav-pills nav-stacked mail-nav">
                  <li class="active"><a href="inbox.jsp"> <i class="fa fa-inbox"></i> Inbox  <span class="label label-theme pull-right inbox-notification">3</span></a></li>
                  ...
                  <table class="table table-inbox table-hover">
                    <tbody>
                      <tr class="unread">
                        ...
                        <td class="view-message  dont-show"><a href="mail_view.jsp">Google Inc.</a></td>
                        <td class="view-message "><a href="mail_view.jsp">Your new account is ready.</a></td>
                      ...
                      <tr class="unread">
                        ...
                        <td class="inbox-small-cells"><i class="fa fa-star"></i></td>
                        <td class="view-message dont-show"><a href="mail_view.jsp">Mark Thompson</a></td>
                        <td class="view-message"><a href="mail_view.jsp">Last project updates</a></td>
                      ...
                      <tr class="unread">
                        ...
                        <td class="inbox-small-cells"><i class="fa fa-star"></i></td>
                        <td class="view-message dont-show"><a href="mail_view.jsp">Wonder Corp.</a></td>
                        <td class="view-message"><a href="mail_view.jsp">Thanks for your registration</a></td>
                        <td class="view-message inbox-small-cells"></td>
                        <td class="view-message text-right">March 15</td>
                      </tr>
                      <tr class="">
                        ...
                        <td class="view-message"><a href="mail_view.jsp">New Friendship Request</a></td>
                        <td class="view-message inbox-small-cells"></td>
                      ...
                      <tr class="">
                        ...
                        <td class="view-message dont-show"><a href="mail_view.jsp">Mark Webber <span class="label label-danger pull-right">urgent</span></a></td>
                        <td class="view-message"><a href="mail_view.jsp">The server is down</a></td>
                        <td class="view-message inbox-small-cells"></td>
                      ...
                      <tr class="">
                        ...
                        <td class="inbox-small-cells"><i class="fa fa-star inbox-started"></i></td>
                        <td class="view-message dont-show"><a href="mail_view.jsp">Facebook</a></td>
                        <td class="view-message"><a href="mail_view.jsp">New message from Patrick S.</a></td>
                        <td class="view-message inbox-small-cells"><i class="fa fa-paperclip"></i></td>
    ...
    <footer class="site-footer">
      <div class="text-center">
        <p>
          &copy; Copyrights <strong>Travelo</strong>. All Rights Reserved
        </p>
        <div class="credits">
          <!--
